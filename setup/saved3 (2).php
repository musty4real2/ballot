...
?>
  <img  style="position:absolute; top:271px; left:201px;" src="<?php echo "../voterspic/$picture";?>"  <?php echo $object->imageResize ($pic[0], $pic[1], 180);?> alt="<?php echo $row['code'];?>" />
  <?php } 

if($picture==""){
$pic=getimagesize("../images/voters_img.gif");
?>
  <img  style="position:absolute; top:270px; left:204px;" src="<?php echo "../images/voters_img.gif";?>"  <?php echo $object->imageResize($pic[0], $pic[1], 150);?> alt="<?php echo $row['code'];?>" />
...
?>
  ...
  <table  height="216" style="position:relative; top:110px; left:20px;">
    <tr>
      <td width="204" height="54"></td>
      <td width="112">Surname:<br/><b style="color:#000;"><?php echo strtoupper($sname);?></b></td>
      <td width="122">Firstname:<br/><b style="color:#000;"><?php echo strtoupper($fname);?></b></td>
      <td width="192">Sex:<br/><b style="color:#000;"><?php echo $sex;?></b></td>
  </tr>
    <tr>
      <td height="59"></td>
    ...
    <tr>
      <td height="93"></td>
            <td>Address:<br/> <b style="color:#000;"> <?php echo $add;?></td>
    ...
    <table border="0" width="680" style="text-align:center; position:relative; top:115px; left:20px;">
      <tr>
        <td height="49"><Center><b>VIN:</b><br/>>>>>><?php echo $code;?>&nbsp;>>>><?php echo date("d M, Y g:h A");?></Center></td>
        </tr>
  </table>
