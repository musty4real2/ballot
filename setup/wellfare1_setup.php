...
<body>
	<?php //include database connect script
...
if(isset($_POST['add'])){
	...
	$sql="INSERT INTO `ballot`.`wellfare1` (
...
header("location:saved.php");
	...
	$sql="INSERT INTO `ballot`.`wellfare1` (
`id` ,`name` ,`pic` ,`votecount`
)VALUES (NULL , '$one', '', ''), (NULL , '$two', '', ''), (NULL , '$three', '', '')";
$queryobject=new ballot;
$result=$queryobject->mysqlQuery($sql);
header("location:saved.php");
	}
...
<legend> Wellfare I</legend>
<?php
$objclass=new ballot;
$all= $objclass->selectAll("wellfare1");
