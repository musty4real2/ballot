...
if(mysql_num_rows($all) < 5){echo "<div><a  title='add new contestant' href='addnew.php?table=vpres&page=edit_vpres_frame.php&position=VICE-PRESIDENT'><img src='../images/add1.gif' width='82' height='70' /></a></div>";}
...
?>
		...
		table=vpres&position=VICE PRESIDENT&page=edit_vpres_frame.php'><img src='../images/edit_ (1).png' width='30' height='30' /></a>";?></td>
  </td>
        ...
        <td width="50"><?php 
   if($row['pic']!=""){
	   echo "<a  title='change picture' href='change_picture.php?id={$row['id']}&table=vpres&position=VICE PRESIDENT'><img src='../images/edit_ (2).png' width='30' height='30' /></a>";
	   }?>
          
          <?php 
   if($row['pic']==""){
	   echo "<a title='add picture'  href='change_picture.php?id={$row['id']}&table=vpres&position=VICE PRESIDENT'><img src='../images/edit_ (2).png' width='30' height='30' /></a>";
	   }?>
  </td>
        
        
        <td width="50">
        <a title="delete this person" href="<?php echo "delete_person.php?id={$row['id']}&table=vpres&page=edit_vpres_frame.php";?>" 
