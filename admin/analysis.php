...
<!--body div-->
<div id="body">
<h1><img src="../images/bulb.gif" width="78" height="130" />Vote Analysis</h1>
...
<center><fieldset>
  ...
  <table width="90%" border="0" class="voterstab" cellspacing="0">
	...
	$all="SELECT * FROM `voted` LIMIT $start, $display";
	$a=mysql_query($all);
 ...
 echo "<tr class='tr'>";  ?>
      ...
      <td><?php echo "<a href='vote_analysis.php?id={$row['voterid']}'>View analysis</a>";?></td>
